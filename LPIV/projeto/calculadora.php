...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link" href="soma.php">Soma</a>
                </li>
                <li class="nav-item">
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="alert alert-warning d-flex align-items-center" role="alert" style="margin-left: 65px; margin-right: 65px; margin-top: 65px">
        ...
        <!-- Título -->
        <div>
            <h3 style="margin-left: 65px; margin-right: 65px; margin-top: 10px; text-align: center;">CALCULADORA</h3>
        </div>

        <!-- Formulário de entrada de valores -->
        <form style="margin-left: 65px; margin-right: 65px; margin-top: 05px; margin-bottom: 30px" action="recebeCalculo.php" method="post">
            <div class="mb-3">
            ...
            <input style="margin-top: 0px;" class="btn btn-primary" type="submit" value="Calcular">
        </form>
