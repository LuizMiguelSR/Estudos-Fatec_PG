...
=======
        ...
        <?PHP 
            echo '<div class="alert alert-primary d-flex align-items-center" role="alert" style="margin-left: 65px; margin-right: 65px; margin-top: 65px;">';
>>>>>>> Stashed changes
            ...
            echo '</svg>';
            echo '<div>';
            echo 'Usuário ou senha errados, digite novamente';
            echo '</div>';
            echo '</div>';
        ?>
<<<<<<< Updated upstream
=======
        ...
        <!-- Formulário de login -->
        <form style="margin-left: 65px; margin-right: 65px; margin-top: 10px;" action="recebe.php" method="post">
            <div class="mb-3">
